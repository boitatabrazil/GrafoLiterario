...
filename = easygui.fileopenbox(msg=None,
                                 title='Abrir arquivo do livro', default='*', filetypes=None, multiple=False)
...
dicname = easygui.fileopenbox(msg=None,
                                 title='Abrir arquivo do dicionario', default='*', filetypes=None, multiple=False)


try:
    dic = pd.read_csv(dicname,delimiter=';')
except:
    easygui.exceptionbox(msg='Dicionario Errado', title='Error')
    sys.exit(1)


window = easygui.integerbox(msg='Digite o tamanho da janela', title='janela', default=None,
                            lowerbound=1, upperbound=None, image=None, root=None)

overlap = easygui.integerbox(msg='Digite o tamanho do overlap', title='overlap', default=None, 
                            lowerbound=0, upperbound=None, image=None, root=None)


limiar = easygui.integerbox(msg='Digite o valor do limiar para aumentar a borda', title='limiar', default=None, 
                            lowerbound=2, upperbound=None, image=None, root=None)


saida =easygui.enterbox(msg='Digite o nome do arquivo de saida', title=' ', default='', strip=True, image=None, root=None)
