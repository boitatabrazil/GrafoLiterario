...
O programa vai pedir algumas coisas:
	...
	janela (o tamanho da janela (quantos tokens ele vai procurar os nomes), a claudia freitas usou 3000 eu acho, mas fica a teu criterio)
	overlap (a interseção entre duas janelas, a claudia freitas usou 500 eu acho, mas fica a teu criterio)
